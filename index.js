...
function compararNotas(tabela1, tabela2) {
  ...
  tabela1.forEach((linha1) => {
    ...
    const comparacaoLinha = {
      ...
      AP1Tabela2: linha2Nome1 ? linha2Nome1.AP1 : 'Não encontrado',
      ...
      AP2Tabela2: linha2Nome2 ? linha2Nome2.AP2 : 'Não encontrado',
